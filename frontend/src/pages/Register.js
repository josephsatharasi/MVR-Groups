    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4" style={{
      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md relative z-10">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          <div>
            <label className="block text-sm font-semibold mb-2 text-blue-700">Username <span className="text-red-500">*</span></label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-semibold mb-2 text-blue-700">Mobile Number <span className="text-red-500">*</span></label>
            <input
              type="tel"
          ...
          <div>
            <label className="block text-sm font-semibold mb-2 text-blue-700">Confirm Password <span className="text-red-500">*</span></label>
            <input
              type="password"
