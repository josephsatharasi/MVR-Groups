    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4" style={{
      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold" style={{ color: '#2F4F4F' }}>Forgot Password</h1>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Remember your password? <Link to="/" className="font-semibold hover:underline" style={{ color: '#2F4F4F' }}>Login here</Link>
        </p>
      </div>
    </div>
  );
